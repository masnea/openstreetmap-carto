@marina-text: #d7d7d9; // also swimming_pool
@wetland-text: darken(#d9dcde, 25%); /* Also for mud */
@shop-icon: #dbdbdb;
@shop-text: #8a888a;
@transportation-icon: #cfd0d1;
@transportation-text: #b8b8b8;
...
@office: #bbbdbf;
@man-made-icon: #7d7a7a;
@advertising-grey: @man-made-icon;
@barrier-icon: #857f7f;
@landform-color: #d6d4d2;
@leisure-green: darken(@park, 60%);
@protected-area: #c5c7c5;
@aboriginal: #b3b0ad;
