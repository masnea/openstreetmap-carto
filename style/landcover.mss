...
@grass: #e3e6e1;        // Lch(90,32,128) also grassland, meadow, village_green, garden, allotments
@scrub: #dadbd7;        // Lch(84,24,122)
@forest: #cdcfcc;       // Lch(80,30,135)
@forest-text: #babdb9;  // Lch(40,30,135)
@park: #e6e8e6;         // Lch(94,30,145)
@allotments: #dde0dc;   // Lch(87,20,135)
@orchard: #d5d9d4; // also vineyard, plant_nursery
...
@residential-line: #d9d9d9; // Lch(75,0,0)
@retail: #e0dcdc;           // Lch(89,16,30)
@retail-line: #d1cdcd;      // Lch(70,25,30)
@commercial: #e6dfdf;       // Lch(89,8.5,25)
@commercial-line: #b3afaf;  // Lch(75,12,25)
@industrial: #e0dadf;       // Lch(89,9,330) (Also used for railway, wastewater_plant)
@industrial-line: #d1cdd0;  // Lch(75,11,330) (Also used for railway-line, wastewater_plant-line)
@farmland: #e0e0dc;         // Lch(94,14,112)
@farmland-line: #ccccc8;    // Lch(80,14,112)
@farmyard: #dbd9d7;         // Lch(89,20,80)
@farmyard-line: #d4d3d2;    // Lch(75,25,80)
...
@rest_area: #e3dede; // also services

// --- Other ----

@bare_ground: #e8e7e6;
@campsite: #dddedc; // also caravan_site, picnic_site
@cemetery: #dce0dd; // also grave_yard
@construction: #c9c9c7; // also brownfield
@heath: #e3e3e1;
...
@sand: #d1d0cd;
@societal_amenities: #d9d9d7;   // Lch(99,13,109)
@tourism: #ebe8e9;
@quarry: #c5c3c3;
@military: #e0dcdc;
@beach: #e3e3e3;
...
@pitch: #d4d6d5;           // Lch(85,22,168) also track
@track: @pitch;
