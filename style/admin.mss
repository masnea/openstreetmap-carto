@admin-boundaries: #0f0f0f; // Lch(47,30,327)
@admin-boundaries-narrow: #0f0f0f; // Lch(42,35,327)
@admin-boundaries-wide: #0f0f0f; // Lch(57,25,327)
...
Overlapping borders are hidden by a #d1cfd1 background line, rendered before each line.
Then all three layers are added to the rendering with comp-op: darken, so that the #d1cfd1 lines will not show
*/
...
#admin-high-zoom[zoom >= 13] {
  ...
  @admin-boundaries/#d1cfd1 dashed lines (of which only the top one is visible),
  and with `comp-op: darken` the #d1cfd1 part is ignored, while the
