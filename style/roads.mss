...
@tertiary-fill: #dbd9d9;
@residential-fill: #dbd9d9;
@service-fill: @residential-fill;
@living-street-fill: #ededed;
@pedestrian-fill: #e6e6e8;
@raceway-fill: #edebeb;
@road-fill: #ddd;
@footway-fill: #dbd6d5;
...
@cycleway-fill: #dcdfe0;
@cycleway-fill-noaccess: #d4d4d9;
@bridleway-fill: #d9dbd9;
@bridleway-fill-noaccess: #d2d6d2;
@track-fill: #babab8;
@track-fill-noaccess: #cfcbca;
@aeroway-fill: #d9d9de;
...
@default-casing: #bfbdbd;
@tertiary-casing: #b0aeae;
...
@destination-marking: #cfd0d1;
@private-marking: #dedcdc;
@private-marking-for-red: #8c8585;
...
@halo-color-for-minor-road:       #c4bebe;
@lowzoom-halo-color:              #c4bebe;
...
#tunnels[zoom >= 10] {
  ...
  ::fill {
    ...
    [feature = 'highway_track'] {
      [zoom >= 13][access != 'no'],
      [zoom >= 15] {
        /* The #c4bebe casing that you mainly see against forests and other dark features */
        #roads-fill[zoom >= 15] {
          background/line-opacity: 0.4;
